...
public class FaceGameObjectLeft30 : AbilityFSM
{
	MovementCC movement;
	//Animator animator;
	...
	{
		Vector3 targetForward = (Quaternion.Euler(0, -30, 0) * (target.transform.position - dummy.transform.position)).normalized;
