...
public class Instantiator : MonoBehaviour
{
	...
	void instantiateAbilities ()
	{
		...
		Texture2D stickySlimeIcon = (Texture2D)Resources.Load("Abilities/Sticky Slime/Icon.png");
	...
	{
		levelBuilder = new LevelBuilder(42, 3);
	}
	
	void instantiatePlayer ()
	{
		player = (GameObject)memoizer.getMemoizedPrefabs("Player");
